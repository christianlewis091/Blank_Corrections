...
def radiocarbon_calcs(stds_dataframe, sample_dataframe):
...
if 'Carbonate CO2 Evolution' in types2:
    ...
    carbonates = radiocarbon_calcs(carbonate_stds, carbonates)
